...
class ApplyDrive : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_apply_drive)
        ...
        {
            val builder = NotificationCompat.Builder(this@ApplyDrive, "My Notification")

            builder.setContentTitle("Application Submitted!")
            builder.setContentText("Company-"+cname + " "+"Role-"+role)
            builder.setSmallIcon(R.drawable.tplogo)
            builder.setAutoCancel(true)
            builder.setStyle(NotificationCompat.InboxStyle())

            val managerCompat = NotificationManagerCompat.from(this@ApplyDrive)
